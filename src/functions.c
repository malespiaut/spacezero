...
int
GameParametres(int option, int param, int value)
{
  /*
...
void
DelCharFromCad(char* cad, char* filter)
{
  /*
...
int
MemUsed(int action, size_t value)
{
