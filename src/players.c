...
void
CreatePlayers(char* clientname, struct Parametres param)
{
  int i, j;
...
void
CreateTeams(struct Parametres param)
{
  int i, nteam = 1;
...
void
AddPlayerGold(int player, int n)
{
  players[player].gold += n;
}
int
GetPlayerProc(int player)
{
