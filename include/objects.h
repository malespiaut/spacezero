...
Object* NewObj(int type, int stype, int x, int y, float vx, float vy, int weapontype, int engtype, int, Object* parent, Object* in);
...
Object* NearestObj(struct HeadObjList* lh, Object* obj, int type, int stype, int status, float* d2);
