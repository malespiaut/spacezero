...
struct IntList*
Add2IntList(struct IntList* list, int id)
{
  /*
     version 01
...
int
IsInIntList(struct IntList* list, int id)
{
  /*
...
int
CountIntList(struct IntList* list)
{
...
int
DelFirstIntList(struct IntList* list)
{
...
int
DelIntList(struct IntList* list)
{
  /*
     version 01
     Delete all the list
...
int
FPrintIntList(FILE* fp, struct IntList* list)
{
  /* return the number of item of the list */
...
int
IsInIntOList(struct IntList* list, int id)
{
  /* return:
     TRUE if id is in the list
     FALSE if not.
...
int
Add2IntIList(struct HeadIntIList* head, int id)
{
  ...
  while (item != NULL)
  {
    ...
    if (item->id > id)
    { /*item is not in the list, adding in the middle */
...
int
IsInIntIList(struct HeadIntIList* head, int id)
{
  /* return:
     TRUE if id is in the list
     FALSE if not.
...
int
DelIntIList(struct HeadIntIList* head)
{
  /* Delete all the list */
...
int
PrintIntIList(struct HeadIntIList head)
{
  /* print the list */
  int n = 0;
  int i;
...
int
Add2CharList(struct CharListHead* hlist, char* cad, int mode)
{
  /*
     version 00
  ...
  if (mode == 1)
  { /* check if is recently added => don't add*/
    m = 0;
    list = hlist->next;
    while (list != NULL)
    {
...
int
Add2CharListWindow(struct CharListHead* hlist, char* cad, int mode, struct Window* w)
{
  /*
     version 00
...
int
PrintCharList(struct CharListHead* hlist)
{
  /*
     version 00
     print the list
...
int
DestroyCharList(struct CharListHead* hlist)
{
  /*
     version 00
     delete all the list
...
struct IntTree*
Add2IntTree(struct IntTree* head, int id)
{
...
int
SizeIntTree(struct IntTree* head, int reset)
{
  /*
    Return:
...
int
IsInIntTree(struct IntTree* head, int id)
{
  /*
    returns:
...
void
DelIntTree(struct IntTree* head)
{
  /*
...
int
CountIntTree(struct IntTree* head)
{
  /*
    Returns:
...
int
Add2TextList(struct HeadTextList* listhead, char* cad, int color)
{
  /*
...
int
DestroyTextList(struct HeadTextList* head)
{
  /*
     delete all the list
     return:
...
int
PrintTextList(struct HeadTextList* head)
{
  struct TextList* lh;
...
int
CountTextList(struct HeadTextList* head)
{
  /*
    returns:
...
int
PosFirstTextList(struct HeadTextList* head, int m)
{
  /*
    returns:
...
int
PosLastTextList(struct HeadTextList* head, int m)
{
  /*
    returns:
...
int
CountColorTextList(struct HeadTextList* head, int m)
{
  /*
    returns:
